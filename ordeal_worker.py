...
from backend.app.engine import SimulationEngine, evaluate_assertions, run_mock_agent, stable_hash
from backend.app.agent_runtime import run_openai_compatible
from backend.app.kafka import make_producer, result_topic, topic_for_capability, json_bytes
